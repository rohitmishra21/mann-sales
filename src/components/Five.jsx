          ...
          <div className="relative mt-40">
            ...
            <div className="top-1/2 absolute left-1/2 -translate-x-1/2 -translate-y-[48%]">
              <img
                ...
                alt="Main Image"
                className="big shadow-2xl shadow-black"
              />
            </div>
          </div>
        </div>
        <div className="w-full flex justify-between px-9 uppercase font-sans font-bold mt-52 border-b-2 border-white py-6">
          <div className="group overflow-y-hidden h-6 cursor-pointer transition-all">
            <h1 className="elem group-hover:-translate-y-full">etcetera</h1>
            <h1 className="ele group-hover:-translate-y-full">etcetera</h1>
          </div>
          <div className="group overflow-y-hidden h-6 cursor-pointer transition-all">
            <h1 className="elem group-hover:-translate-y-full">etcetera</h1>
            <h1 className="ele group-hover:-translate-y-full">etcetera</h1>
