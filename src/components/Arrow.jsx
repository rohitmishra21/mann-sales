 ...
 <div className="main pl-6">
     <div className="group border-2 border-[#FF6432] h-[60px] w-[80px] xl:h-[90px] xl:w-[130px] rounded-full flex justify-center items-center overflow-hidden hover:bg-[#FF6432] ">
          <div className=" border-[#FF6432] animate-move hidden group-hover:block">
            ...
            >
              <path
                d="M22 20C10.9561 20 2 11.0439 2 0"
                strokeWidth="3"
                strokeMiterlimit="10"
              ></path>
              <path
                d="M2 40C2 28.9561 10.9561 20 22 20"
                strokeWidth="3"
                strokeMiterlimit="10"
              ></path>
            </svg>
          ...
          <div className=" border-[#FF6432] animate-move hidden group-hover:block">
            <svg
              className="h-10 w-10 rounded-2xl text-[#FF6432] "
              viewBox="0 0 22 40"
              fill="none"
              stroke="currentColor"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div className=" border-[#FF6432]  group-hover:hidden">
            <svg
              className="h-10 w-10 rounded-2xl text-[#FF6432] "
              viewBox="0 0 22 40"
              fill="none"
